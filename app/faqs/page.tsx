  ...
  const QA = [
    {
      ...
      answer:
        "Jetwill Stocks has for years been one of the most trusted and reliable crypto broker company, with our trusted experts that work irelessly to ensure our clients get the most of their investment.",
    },
    {
    ...
    {
      question: "How Can I Start Working With Jetwill Stocks?",
      answer:
        "First step is to signup on our company, choose an investments plan that best suits you and start earning with Jetwill Stocks today.",
    },
  ];
  return (
