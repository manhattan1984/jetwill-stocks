...
const Reviews = () => {
  const listOfReviews = [
    ...
    },
    {
      ...
      message: `I have been able to earn regular profits by just using this platform. I have tried many others but Jetwill Stocks is the best.`,
    },
    {
      name: "Anita Roberts",
      title: "Highly Recommended",
      message: `Thanks to Jetwillstocks, I'm on my way to an early retirement. I didn't know it was possible to make this much money just by investing.`,
    },
    {
      name: "Jake Matthews",
      title: "I'm Highly Impressed",
      message: `Jetwill Stocks has cleared all my doubts about investing. My only regret is I didn't start investing sooner, I'd have been a retired millionaire by now.`,
    },
  ];
