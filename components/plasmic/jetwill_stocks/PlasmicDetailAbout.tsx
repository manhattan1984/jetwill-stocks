...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: O_pcyI8SEMHQrj/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__k4YTl)}>
            <p.PlasmicImg
              ...
              src={{
                src: "/plasmic/jetwill_stocks/images/checklistpng.png",
                fullWidth: 48,
                fullHeight: 48,
          ...
          <div className={classNames(projectcss.all, sty.column__rnx1W)}>
            <h5
