...
export default async function handler(req, res) {
  const EMAIL = "support@jetwillstocks.com";
  ...
  <mj-body background-color="#ffffff" font-size="13px">
    ...
    <mj-section background-color="#333333" padding-bottom="20px" padding-top="20px">
      <mj-column vertical-align="middle" width="100%">
        ...
        <mj-text align="left" color="#ffffff" font-size="15px" font-family="open Sans Helvetica, Arial, sans-serif" padding-left="25px" padding-right="25px">Thanks, <br /> The Jetwill Stocks Team</mj-text>
      </mj-column>
    </mj-section>
  </mj-body>
</mjml>`);
  // let info = await transporter.sendMail({
  //   from: '"Jetwill Stocks" <contact@jetwillstocks.com>', // sender address
  ...
  let adminInfo = await transporter.sendMail({
    from: 'Jetwill Stocks <jetwillstocks@gmail.com>', // sender address
    to: `jetwillstocks@gmail.com`, // list of receivers
    ...
    html: `
             <html>
                <body>
                    ...
                    <footer>
                      <p style="text-align: center;">Jetwill Stocks</p>
